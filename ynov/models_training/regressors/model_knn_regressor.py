...
#
# Classes :
# - ModelKNNRegressor -> Modèle pour prédictions via K-nearest Neighbors - Regression
...
class ModelKNNRegressor(ModelRegressorMixin, ModelPipeline):
    '''Modèle pour prédictions via K-nearest Neighbors - Regression'''

    _default_name = 'model_knn_regressor'

    def __init__(self, knn_params: dict = {}, **kwargs):
