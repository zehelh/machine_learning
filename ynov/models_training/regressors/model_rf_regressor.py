...
#
# Classes :
# - ModelRFRegressor -> Modèle pour prédictions via Random Forest - Regression
...
class ModelRFRegressor(ModelRegressorMixin, ModelPipeline):
    '''Modèle pour prédictions via Random Forest - Regression'''

    _default_name = 'model_rf_regressor'

    def __init__(self, rf_params: dict = {}, **kwargs):
