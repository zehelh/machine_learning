...
from ynov.models_training.regressors.model_svr_regressor import ModelSVRRegressor
...
class ModelSVRRegressorTests(unittest.TestCase):
    ...
    def test01_model_svr_regressor_init(self):
        '''Test de l'initialisation de ynov.models_training.model_svr_regressor.ModelSVRRegressor'''
    ...
    def test02_model_svr_regressor_predict(self):
        '''Test de la fonction predict de ynov.models_training.model_svr_regressor.ModelSVRRegressor'''
    ...
    def test03_model_svr_regressor_save(self):
        '''Test de la fonction save de ynov.models_training.model_svr_regressor.ModelSVRRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_svr_regressor_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.regressors.model_svr_regressor.ModelSVRRegressor.reload_from_standalone'''
