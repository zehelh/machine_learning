...
class ModelClassifierMixinTests(unittest.TestCase):
    ...
    def test01_model_classifier_init(self):
        '''Test de l'initialisation de ynov.models_training.model_classifier.ModelClassifierMixin'''
    ...
    def test02_model_classifier_predict_with_proba(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.predict_with_proba'''
    ...
    def test03_model_classifier_get_predict_position(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_predict_position'''
    ...
    def test04_model_classifier_get_classes_from_proba(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_classes_from_proba'''
    ...
    def test05_model_classifier_get_top_n_from_proba(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_top_n_from_proba'''
    ...
    def test06_model_classifier_inverse_transform(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.inverse_transform'''
    ...
    def test07_model_classifier_get_and_save_metrics(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_and_save_metrics'''
    ...
    def test08_model_classifier_get_metrics_simple_monolabel(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_metrics_simple_monolabel'''
    ...
    def test09_model_classifier_get_metrics_simple_multilabel(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.get_metrics_simple_multilabel'''
    ...
    def test10_model_classifier_update_info_from_c_mat(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin._update_info_from_c_mat'''
    ...
    def test11_model_classifier_save(self):
        '''Test de la fonction ynov.models_training.model_classifier.ModelClassifierMixin.save'''
