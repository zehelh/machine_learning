...
from ynov.models_training.classifiers.model_ridge_classifier import ModelRidgeClassifier
...
class ModelRidgeClassifierTests(unittest.TestCase):
    '''Main class to test model_ridge_classifier'''
    ...
    def test01_model_ridge_classifier_init(self):
        '''Test de ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier.__init__'''

        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)

        # Init., test all params
        model = ModelRidgeClassifier(model_dir=model_dir)
        ...
        # Check Ridge params en fonction multi-label & multiclass strategy
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=False, ridge_params={'alpha': 0.4, 'fit_intercept': False})
        self.assertEqual(model.pipeline['ridge'].alpha, 0.4)
        self.assertEqual(model.pipeline['ridge'].fit_intercept, False)
        remove_dir(model_dir)
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=False, multiclass_strategy='ovr', ridge_params={'alpha': 0.4, 'fit_intercept': False})
        ...
        remove_dir(model_dir)
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=False, multiclass_strategy='ovo', ridge_params={'alpha': 0.4, 'fit_intercept': False})
        self.assertEqual(model.multiclass_strategy, 'ovo')
        self.assertEqual(model.pipeline['ridge'].estimator.alpha, 0.4)
        self.assertEqual(model.pipeline['ridge'].estimator.fit_intercept, False)
        remove_dir(model_dir)
        #
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=True, ridge_params={'alpha': 0.4, 'fit_intercept': False})
        self.assertEqual(model.pipeline['ridge'].estimator.alpha, 0.4)
        self.assertEqual(model.pipeline['ridge'].estimator.fit_intercept, False)
        self.assertEqual(model.multi_label, True)
        remove_dir(model_dir)
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=True, multiclass_strategy='ovr', ridge_params={'alpha': 0.4, 'fit_intercept': False})
        self.assertEqual(model.multiclass_strategy, 'ovr')
        self.assertEqual(model.pipeline['ridge'].estimator.alpha, 0.4)
        self.assertEqual(model.pipeline['ridge'].estimator.fit_intercept, False)
        self.assertEqual(model.multi_label, True)
        remove_dir(model_dir)
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=True, multiclass_strategy='ovo', ridge_params={'alpha': 0.4, 'fit_intercept': False})
        self.assertEqual(model.multiclass_strategy, 'ovo')
        self.assertEqual(model.pipeline['ridge'].estimator.alpha, 0.4)
        self.assertEqual(model.pipeline['ridge'].estimator.fit_intercept, False)
        self.assertEqual(model.multi_label, True)
        ...
        with self.assertRaises(ValueError):
            model = ModelRidgeClassifier(model_dir=model_dir, multi_label=False, multiclass_strategy='toto', ridge_params={'alpha': 0.4, 'fit_intercept': False})
        remove_dir(model_dir)

    def test02_model_ridge_classifier_predict(self):
        '''Test de la fonction predict de ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier'''
    ...
    def test03_model_ridge_classifier_predict_proba(self):
        '''Test de la fonction predict_proba de ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier'''
    ...
    def test04_model_ridge_classifier_get_predict_position(self):
        '''Test de la fonction ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier.get_predict_position'''
    ...
    def test05_model_ridge_classifier_save(self):
        '''Test de la fonction save de ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier'''

        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)

        # Fonctionnement nominal
        model = ModelRidgeClassifier(model_dir=model_dir, multi_label=False, multiclass_strategy='ovr')
        ...
        self.assertTrue('ridge_confs' in configs.keys())
        remove_dir(model_dir)

    def test06_model_ridge_classifier_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.classifiers.model_ridge_classifier.ModelRidgeClassifier.reload_from_standalone'''
        ...
        new_model = ModelRidgeClassifier()
        ...
        self.assertEqual(model.ridge.get_params(), ridge.get_params())
