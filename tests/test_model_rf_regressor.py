...
from ynov.models_training.regressors.model_rf_regressor import ModelRFRegressor
...
class ModelRFRegressorTests(unittest.TestCase):
    ...
    def test01_model_rf_regressor_init(self):
        '''Test de l'initialisation de ynov.models_training.model_rf_regressor.ModelRFRegressor'''
        ...
        # Check RF params
        model = ModelRFRegressor(model_dir=model_dir, rf_params={'n_estimators': 51, 'max_depth': 6})
    ...
    def test02_model_rf_regressor_predict(self):
        '''Test de la fonction predict de ynov.models_training.model_rf_regressor.ModelRFRegressor'''
    ...
    def test03_model_rf_regressor_save(self):
        '''Test de la fonction save de ynov.models_training.model_rf_regressor.ModelRFRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_rf_regressor_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.regressors.model_rf_regressor.ModelRFRegressor.reload_from_standalone'''
