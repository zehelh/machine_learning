...
from ynov.models_training.regressors.model_gbt_regressor import ModelGBTRegressor
...
class ModelGBTRegressorTests(unittest.TestCase):
    ...
    def test01_model_gbt_regressor_init(self):
        '''Test de l'initialisation de ynov.models_training.model_gbt_regressor.ModelGBTRegressor'''
    ...
    def test02_model_gbt_regressor_predict(self):
        '''Test de la fonction predict de ynov.models_training.model_gbt_regressor.ModelGBTRegressor'''
    ...
    def test03_model_gbt_regressor_save(self):
        '''Test de la fonction save de ynov.models_training.model_gbt_regressor.ModelGBTRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_gbt_regressor_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.regressors.model_gbt_regressor.ModelGBTRegressor.reload_from_standalone'''
