...
from ynov.models_training.classifiers.model_sgd_classifier import ModelSGDClassifier
...
class ModelSGDClassifierTests(unittest.TestCase):
    ...
    def test01_model_sgd_classifier_init(self):
        '''Test de ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier.__init__'''
        ...
        # Check SGD params en fonction multi-label & multiclass strategy
    ...
    def test02_model_sgd_classifier_predict(self):
        '''Test de la fonction predict de ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier'''
    ...
    def test03_model_sgd_classifier_predict_proba(self):
        '''Test de la fonction predict_proba de ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier'''
        ...
        #################
        # On refait les tests avec une loss qui autorise les probas
        #################
    ...
    def test04_model_sgd_classifier_get_predict_position(self):
        '''Test de la fonction ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier.get_predict_position'''
    ...
    def test05_model_sgd_classifier_save(self):
        '''Test de la fonction save de ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier'''
    ...
    def test06_model_sgd_classifier_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.classifiers.model_sgd_classifier.ModelSGDClassifier.reload_from_standalone'''
