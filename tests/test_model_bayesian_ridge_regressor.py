...
from ynov.models_training.regressors.model_bayesian_ridge_regressor import ModelBayesianRidgeRegressor
...
class ModelBayesianRidgeRegressorTests(unittest.TestCase):
    ...
    def test01_model_bayesian_ridge_regressor_init(self):
        '''Test de l'initialisation de ynov.models_training.model_bayesian_ridge_regressor.ModelBayesianRidgeRegressor'''
    ...
    def test02_model_bayesian_ridge_regressor_predict(self):
        '''Test de la fonction predict de ynov.models_training.model_bayesian_ridge_regressor.ModelBayesianRidgeRegressor'''
    ...
    def test03_model_bayesian_ridge_regressor_save(self):
        '''Test de la fonction save de ynov.models_training.model_bayesian_ridge_regressor.ModelBayesianRidgeRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_bayesian_ridge_regressor_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.regressors.model_bayesian_ridge_regressor.ModelBayesianRidgeRegressor.reload_from_standalone'''
