...
from ynov.models_training.regressors.model_lgbm_regressor import ModelLGBMRegressor
...
class ModelLGBMRegressorTests(unittest.TestCase):
    '''Main class to test model_lgbm_regressor'''
    ...
    def test01_model_lgbm_regressor_init(self):
        '''Test de l'initialisation de ynov.models_training.model_lgbm_regressor.ModelLGBMRegressor'''

        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)

        # Init., test all params
        model = ModelLGBMRegressor(model_dir=model_dir)
    ...
    def test02_model_lgbm_regressor_predict(self):
        '''Test de la fonction predict de ynov.models_training.model_lgbm_regressor.ModelLGBMRegressor'''
        ...
        # Regressor
        model = ModelLGBMRegressor(x_col=x_col, y_col=y_col_mono, model_dir=model_dir)
    ...
    def test03_model_lgbm_regressor_save(self):
        '''Test de la fonction save de ynov.models_training.model_lgbm_regressor.ModelLGBMRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_lgbm_regressor_reload_from_standalone(self):
        '''Test de la fonction ynov.models_training.regressors.model_lgbm_regressor.ModelLGBMRegressor.reload_from_standalone'''
